...
class CrudRoutesFactory {
    ...
    mergeOptions() {
        ...
        this.options.query = Object.assign(Object.assign({}, module_1.CrudConfigService.config.query), query);
        ...
        const operators = (0, util_1.isObjectFull)(this.options.operators)
        ...
        const serialize = (0, util_1.isObjectFull)(this.options.serialize)
            ? this.options.serialize
            : {};
        this.options.serialize = Object.assign(Object.assign({}, module_1.CrudConfigService.config.serialize), serialize);
        ...
        this.options.serialize.delete =
            (0, util_1.isFalse)(this.options.serialize.delete) ||
    ...
    setResponseModels() {
        const modelType = (0, util_1.isFunction)(this.modelType)
            ? this.modelType
            : serialize_helper_1.SerializeHelper.createGetOneResponseDto(this.modelName);
        this.swaggerModels.get = (0, util_1.isFunction)(this.options.serialize.get)
        ...
        this.swaggerModels.create = (0, util_1.isFunction)(this.options.serialize.create)
            ? this.options.serialize.create
            : modelType;
        this.swaggerModels.update = (0, util_1.isFunction)(this.options.serialize.update)
            ? this.options.serialize.update
            : modelType;
        this.swaggerModels.replace = (0, util_1.isFunction)(this.options.serialize.replace)
            ? this.options.serialize.replace
            : modelType;
        this.swaggerModels.delete = (0, util_1.isFunction)(this.options.serialize.delete)
            ? this.options.serialize.delete
            : modelType;
        this.swaggerModels.recover = (0, util_1.isFunction)(this.options.serialize.recover)
    ...
    overrideRoutes(routesSchema) {
        (0, util_1.getOwnPropNames)(this.targetProto).forEach((name) => {
            ...
            if (override && route && route.enable) {
                ...
                swagger_helper_1.Swagger.setOperation(Object.assign(Object.assign({}, baseOperation), operation), this.targetProto[name]);
                swagger_helper_1.Swagger.setParams([...baseSwaggerParams, ...swaggerParams], this.targetProto[name]);
                swagger_helper_1.Swagger.setResponseOk(Object.assign(Object.assign({}, baseResponseOk), responseOk), this.targetProto[name]);
    ...
    overrideParsedBodyDecorator(override, name) {
        ...
        if (withBody && parsedBody) {
            ...
            reflection_helper_1.R.setRouteArgs(Object.assign(Object.assign({}, routeArgs), { [key]: Object.assign(Object.assign({}, baseBodyArg), { index: parsedBody.index }) }), this.target, name);
    ...
    setRouteArgs(name) {
        ...
        if ((0, util_1.isIn)(name, routes)) {
            ...
            const groupEnum = (0, util_1.isIn)(name, ['updateOneBase', 'replaceOneBase'])
                ? UPDATE
                : CREATE;
        ...
        reflection_helper_1.R.setRouteArgs(Object.assign(Object.assign({}, reflection_helper_1.R.setParsedRequestArg(0)), rest), this.target, name);
    }
    ...
    setSwaggerPathParams(name) {
        ...
        const params = (0, util_1.objKeys)(this.options.params)
            ...
            .reduce((a, c) => (Object.assign(Object.assign({}, a), { [c]: this.options.params[c] })), {});
    ...
    setSwaggerResponseOk(name) {
        ...
        swagger_helper_1.Swagger.setResponseOk(Object.assign(Object.assign({}, metadata), metadataToAdd), this.targetProto[name]);
    }
