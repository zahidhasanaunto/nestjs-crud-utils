...
class RequestQueryBuilder {
    ...
    static create(params, customOperators) {
        ...
        return (0, util_1.isObject)(params) ? qb.createFromParams(params, customOperators) : qb;
    }
    get options() {
        return RequestQueryBuilder._options;
    }
    setParamNames() {
        Object.keys(RequestQueryBuilder._options.paramNamesMap).forEach((key) => {
            ...
            this.paramNames[key] = (0, util_1.isString)(name)
                ? name
                : name[0];
        });
    }
    ...
    select(fields) {
        if ((0, util_1.isArrayFull)(fields)) {
    ...
    search(s) {
        if (!(0, util_1.isNil)(s) && (0, util_1.isObject)(s)) {
    ...
    setJoin(j) {
        if (!(0, util_1.isNil)(j)) {
            ...
            this.queryObject[param] = [
                ...this.queryObject[param],
                ...(Array.isArray(j) && !(0, util_1.isString)(j[0])
    ...
    sortBy(s) {
        if (!(0, util_1.isNil)(s)) {
            ...
            this.queryObject[param] = [
                ...this.queryObject[param],
                ...(Array.isArray(s) && !(0, util_1.isString)(s[0])
    ...
    cond(f, cond = 'search', customOperators) {
        ...
        return (filter.field +
            d +
            filter.operator +
            ((0, util_1.hasValue)(filter.value) ? d + filter.value : ''));
    }
    addJoin(j) {
        ...
        return (join.field + ((0, util_1.isArrayFull)(join.select) ? d + join.select.join(ds) : ''));
    }
    addSortBy(s) {
    ...
    checkQueryObjectParam(cond, defaults) {
        ...
        if ((0, util_1.isNil)(this.queryObject[param]) && !(0, util_1.isUndefined)(defaults)) {
    ...
    setCondition(f, cond, customOperators) {
        if (!(0, util_1.isNil)(f)) {
            ...
            this.queryObject[param] = [
                ...this.queryObject[param],
                ...(Array.isArray(f) && !(0, util_1.isString)(f[0])
